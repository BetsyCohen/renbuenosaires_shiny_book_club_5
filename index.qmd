...
![](assets/cat-theme/turso-03.svg){.absolute top=100 right=100 width="450" height="450"}


:::::: columns
::::  {.column width="50%"}
::: {.spacer style="height:50%;"}
A veces [confirmar acciones con un *“¿estás seguro?”*]{.purple-text} no sirve

Porque los usuarios se acostumbran a clickear [Sí]{.blue-text}

Esta opción permite [deshacer]{.pink-text} luego de ejecutar la acción (como pasa con los mails). 
