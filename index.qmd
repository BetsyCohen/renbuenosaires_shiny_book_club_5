...
![](assets/cat-theme/head-21.svg){.absolute bottom=50 right=50 width="150" height="150"}
![](assets/cat-theme/head-21.svg){.absolute bottom=50 right=180 width="150" height="150"}
![](assets/cat-theme/head-21.svg){.absolute bottom=50 right=310 width="150" height="150"}
![](assets/cat-theme/head-21.svg){.absolute bottom=50 right=440 width="150" height="150"}
...
principal hasta que no se haya procesado el diálogo]{.purple-text}. Lo definimos
